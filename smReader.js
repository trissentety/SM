...
function step(timestamp) {
    ...
    while (chartNumber == 2 && differenceRound > combo && S <= secondChart.length) {
        ...
        if (chartNumber == 2) {
            ...
            if (secondChart[S] == "4100") {
                movementAccB += 1;
            }
            if (secondChart[S] == "4010") {
                movementAccC += 1;
            }
            if (secondChart[S] == "4001") {
                movementAccD += 1;
            }
            if (secondChart[S] == "4110") {
                movementAccB += 1;
                movementAccC += 1;
            }
            if (secondChart[S] == "4101") {
                movementAccB += 1;
                movementAccD += 1;
            }
            if (secondChart[S] == "4011") {
                movementAccC += 1;
                movementAccD += 1;
            }
            if (secondChart[S] == "4111") {
                movementAccB += 1;
                movementAccC += 1;
                movementAccD += 1;
            }
            if (secondChart[S] == "1400") {
                movementAccA += 1;
            }
            if (secondChart[S] == "0410") {
                movementAccC += 1;
            }
            if (secondChart[S] == "0401") {
                movementAccD += 1;
            }
            if (secondChart[S] == "1410") {
                movementAccA += 1;
                movementAccC += 1;
            }
            if (secondChart[S] == "1401") {
                movementAccA += 1;
                movementAccC += 1;
            }
            if (secondChart[S] == "0411") {
                movementAccC += 1;
                movementAccD += 1;
            }
            if (secondChart[S] == "1411") {
                movementAccA += 1;
                movementAccC += 1;
                movementAccD += 1;
            }
            if (secondChart[S] == "1040") {
                movementAccA += 1;
            }
            if (secondChart[S] == "0140") {
                movementAccB += 1;
            }
            if (secondChart[S] == "0041") {
                movementAccD += 1;
            }
            if (secondChart[S] == "1140") {
                movementAccA += 1;
                movementAccB += 1;
            }
            if (secondChart[S] == "1041") {
                movementAccA += 1;
                movementAccD += 1;
            }
            if (secondChart[S] == "0141") {
                movementAccB += 1;
                movementAccD += 1;
            }
            if (secondChart[S] == "1141") {
                movementAccA += 1;
                movementAccB += 1;
                movementAccD += 1;
            }
            if (secondChart[S] == "1004") {
                movementAccA += 1;
            }
            if (secondChart[S] == "0104") {
                movementAccB += 1;
            }
            if (secondChart[S] == "0014") {
                movementAccC += 1;
            }
            if (secondChart[S] == "1104") {
                movementAccA += 1;
                movementAccB += 1;
            }
            if (secondChart[S] == "1014") {
                movementAccA += 1;
                movementAccC += 1;
            }
            if (secondChart[S] == "0114") {
                movementAccB += 1;
                movementAccC += 1;
            }
            if (secondChart[S] == "1114") {
                movementAccA += 1;
                movementAccB += 1;
                movementAccC += 1;
            }
            ...
            if (secondChart[S] == "1202") {
                movementAccA += 1;
                movementAccB += 1;
                movementAccD += 1;
            }
            if (secondChart[S] == "0212") {
                movementAccB += 1;
                movementAccC += 1;
                movementAccD += 1;
            }
